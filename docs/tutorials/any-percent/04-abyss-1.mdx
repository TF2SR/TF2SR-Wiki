...
<YouTube youTubeId="uKAXPnldrik" skipTo={{ h:0, m:4, s:40 }} />
...
Nobody really uses Vibecheck+ afaik because once you are good enough to do Vibecheck+ you can just do the oob route. 
Nonetheless, if you want to learn Vibecheck+ you'll have to ask people in the TF2SR discord as I don't know how to do it. -mats
...
<YouTube youTubeId="uKAXPnldrik" skipTo={{ h:0, m:5, s:53 }} />
...
<YouTube youTubeId="uKAXPnldrik" skipTo={{ h:0, m:15, s:30 }} />
<br/>

### Frag Clear
<YouTube youTubeId="uKAXPnldrik" skipTo={{ h:0, m:14, s:43 }} />
:::
...
<YouTube youTubeId="CDf8SRUiXHk?si=B3wjfQyTqaTxOhu0" />
