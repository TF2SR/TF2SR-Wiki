...
Richter fight is the last major part of the level, so it can be easy to overlook it, but it is definetely worth putting time into and getting consistent times with it.
