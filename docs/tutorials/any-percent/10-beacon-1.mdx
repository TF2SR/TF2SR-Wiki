...
If you performed the titanless route for abyss 1 earlier, its important to quickly exit to menu here and reload (this can also be done at the start of EnC1 instead)
