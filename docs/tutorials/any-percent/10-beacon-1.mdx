...
:::tip Note: If you performed the titanless route for abyss 1 earlier, its important to quickly exit to menu here and reload (this can also be done at the start of EnC1 instead)
:::
...
:::tip Note: Due to randomness based on hardware, some people have less stalkers compared to others; a similar strategy applies, except you may want to use the firestars on different stalkers.
:::
