...
On the zipline, select the lower dialogue option ("There's got to be an easier way, BT") as quickly as possible. You have to reach the ground to trigger the next the cutscene, so do **not** land in the secret upper area with the satchels.
...
<YouTube youTubeId="https://www.youtube.com/watch?v=U1szguexnpk&t=24s" />

This strat is quite hard to grasp at first, but it becomes relatively easier once you get it down. I would say It's worth going for at around a 1:25 goal time -next racer one
