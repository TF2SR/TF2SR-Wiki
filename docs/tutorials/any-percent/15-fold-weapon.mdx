...
When watching the intro cutscene, selecting the top dialogue option will be fastest. 

![](img\KhJnqAe4kW.png)

After the first cutscene, BT's dialogue can be triggered early by walking backwards.

:::diffe

### Flotsa Strat

<YouTube youTubeId="-TPsQlXs4uM"/>
...
Make sure to select Northstar [or Brute? -mats] before disembarking from BT. Otherwise some abilities might be on cooldown at the start of *Slone Fight*. 
