...
Go to lastimosa and choose the upper dialouge to move on.

![](img/gauntlet_dialouge1.png)

then a few seconds after, choose the lower dialouge for less rambling.

![](img/gauntlet_dialouge2.png)
...
What follows is a cutscene, so you dont need to do anything until you get to the difficulty options, where you select easy.
