...
As soon as the level starts, return to menu if you havent already done so in Beacon 1. Menuing in EnC1 will not give you the Ion Titan loadout required to do Snakesplitter.
