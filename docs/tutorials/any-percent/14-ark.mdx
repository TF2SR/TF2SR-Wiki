...
Equip the northstar loadout before the viper intro cutscene. Charge up a shot (doesn't have to be fully charged, but at least like 3/4 charged), and swap to ion right after firing. Hold down the button for laser shot, then hold down ads, and fire the shot. Continue to hold down ads and shoot viper with the splitter riffle. The splitter rifle does triple damage when ads'd, but consumes energy, and there's meant to be a nerf that prevents you from getting the triple damage right after the laser shot. However, by holding ads after starting the laser shot, and continuing to hold it down after the shot, you don't get the nerf, and can do massive damage immediately. You can also hit crits, which recharges your energy. If your aim is good, you can kill viper before he has the chance to fly backwards.
As soon as viper dies, swap to the ronin loadout, activate sword core, and use it to dice up the 2 scorches. You only get 3 hits with the sword core before it runs out, so try to hit both titans at the same time if you can. If you can't kill both with the sword core, finish the remaining titan(s) with the shotgun.

<YouTube youTubeId="hk5ZGIT8ypI" />

If you can't kill viper immediately with ion (the splitter rifle runs out of ammo), switch from ion to tone, and then from tone to expedition quickly. You are all out of energy at this point, so all of your abilities are on cooldown, but if you swap from ion to tone to expedition, it recharges expedition's acolyte rockets. You can then lock onto viper with it, and use it along with the chaingun to finish him off. Then swap to ronin and continue normally from there.

<YouTube youTubeId="o6rxamEKY1E" />
:::
